<template>
  <header class="fixed top-0 left-0 w-full z-50 px-6 md:px-10">
    ...
    <div class="flex items-center justify-between py-6 border-b border-beige/15">
      <!-- Logo -->
      <NuxtLink to="/" aria-label="Earth AI home">
        <!-- TODO: replace with the actual Earth AI logo SVG -->
        <span class="text-beige font-serif text-lg tracking-tight">EARTH AI</span>
      </NuxtLink>
